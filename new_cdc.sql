BEGIN;
    ALTER TABLE waldo.album_folder_shares DISABLE TRIGGER write_to_event_log_album_folder_shares;
    ALTER TABLE waldo.album_folders_members DISABLE TRIGGER write_to_event_log_album_folders_members;
    ALTER TABLE waldo.albums DISABLE TRIGGER write_to_event_log_albums;
    ALTER TABLE waldo.album_shares DISABLE TRIGGER write_to_event_log_album_shares;
    ALTER TABLE waldo.albums_memberships DISABLE TRIGGER write_to_event_log_albums_memberships;
    ALTER TABLE waldo.auth_phone_verifications DISABLE TRIGGER write_to_event_log_auth_phone_verifications;
    ALTER TABLE waldo.face_match_votes DISABLE TRIGGER write_to_event_log_face_match_votes;
    ALTER TABLE waldo.health_check DISABLE TRIGGER write_to_event_log_health_check;
    ALTER TABLE waldo.identity_uniform_album_folder_tags DISABLE TRIGGER write_to_event_log_identity_uniform_album_folder_tags;
    ALTER TABLE waldo.matched_photo_deliveries DISABLE TRIGGER write_to_event_log_matched_photo_deliveries;
    ALTER TABLE waldo.matched_photos DISABLE TRIGGER write_to_event_log_matched_photos;
    ALTER TABLE waldo.photo_share_blocks DISABLE TRIGGER write_to_event_log_photo_share_blocks;
    ALTER TABLE waldo.photostreams_photos DISABLE TRIGGER write_to_event_log_photostreams_photos;
    ALTER TABLE waldo.pub_commandering_identities DISABLE TRIGGER write_to_event_log_pub_commandering_identities;
    ALTER TABLE waldo.purchased_album_folders_identities DISABLE TRIGGER write_to_event_log_purchased_album_folders_identities;
    ALTER TABLE waldo.purchased_albums_identities DISABLE TRIGGER write_to_event_log_purchased_albums_identities;
    ALTER TABLE waldo.roster_identity_linked_identities DISABLE TRIGGER write_to_event_log_roster_identity_linked_identities;
    ALTER TABLE waldo.selected_identities DISABLE TRIGGER write_to_event_log_selected_identities;
    ALTER TABLE waldo.selected_identity_links DISABLE TRIGGER write_to_event_log_selected_identity_links;
    ALTER TABLE waldo.subscribed_album_folders_identities DISABLE TRIGGER write_to_event_log_subscribed_album_folders_identities;
    ALTER TABLE waldo.transaction_refunds DISABLE TRIGGER write_to_event_log_transaction_refunds;
    ALTER TABLE waldo.watermark_config DISABLE TRIGGER write_to_event_log_watermark_config;
    ALTER TABLE waldo.__events_log DISABLE TRIGGER notify_on_event_log_updated;
